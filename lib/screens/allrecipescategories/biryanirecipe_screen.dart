...
class RiceRecipes extends StatefulWidget {
  const RiceRecipes({Key? key}) : super(key: key);

  @override
  State<RiceRecipes> createState() => _RiceRecipesState();
}

class _RiceRecipesState extends State<RiceRecipes> {
